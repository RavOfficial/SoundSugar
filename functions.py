...
async def generate_cover_square(requested_by, title, artist, duration, thumbnail):
    ...
    bigfont = ImageFont.truetype("etc/bigfont.otf", 35)
    draw.text((450, 10), f"Powered by HARP TECH", (255, 255, 255), font=bigfont)
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    bigfont = ImageFont.truetype("etc/bigfont.otf", 45)
    draw.text((750, 10), f"Powered by HARP TECH", (255, 255, 255), font=bigfont)
    draw.text((190, 553), f"Title: {title}", (255, 178, 0), font=font)
    draw.text(
        (190, 593), f"Duration: {duration}", (255, 255, 255), font=font
    )
    draw.text((190, 633), f"Views: {views}", (255, 255, 255), font=font)
    draw.text((190, 673),
        f"Played By: {requested_by}",
        (255, 255, 255),
        font=font,
